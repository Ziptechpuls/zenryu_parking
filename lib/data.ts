...
export const ZENRYU_DATA: ZenryuData = {
  ...
  /* よくあるご質問 */
  faqs: [
    { q: '全琉空港パーキングの料金はいくらですか?', a: '全琉空港パーキングは1日¥1,000の一律料金でご利用いただけます。日数分のみのわかりやすい料金です。カーケアコース (松竹梅) と併せてご予約いただくと、ご旅行期間中にコースの仕上げもご提供いたします。例: 3泊4日で竹コースをご利用 = ¥1,000×4日 + ¥15,000。' },
    { q: '全琉空港パーキングの予約は必要ですか?', a: '事前のご予約をお願いしております。お電話または公式Instagramのダイレクトメッセージより、ご出発日・ご帰着日をお知らせください。空き状況を確認のうえお席を確保いたします。' },
    { q: '長期の旅行・出張でも車を預けられますか?', a: 'はい、数日から長期のお預かりまで対応しております。料金は1日¥1,000の一律で日数分のみ。GW・お盆・年末年始など長期休暇中の全琉空港パーキングとしてもご利用いただけます。' },
