...
export const metadata: Metadata = {
  title: '全琉空港パーキング ¥1,000/日｜送迎・カーケア付き駐車場 | ゼンリュウ',
  description:
    '全琉空港パーキングならゼンリュウ。1日¥1,000で空港すぐそばに愛車をお預かり、空港まで送迎付き。ご旅行・ご出張中の駐車場をお探しの方へ。お預かり中に手洗い洗車・コーティングを施工するカーケアコース (松竹梅 ¥5,000〜) もご利用いただけます。',
  keywords: [
    '全琉空港パーキング',
    '那覇空港 駐車場',
    '那覇空港 駐車場 預ける',
  ...
  openGraph: {
    title: '全琉空港パーキング ¥1,000/日｜送迎・カーケア付き | ゼンリュウ',
